...
export default function Home() {
    return (
        <div className={.flexContainer + " flex-col min-h-screen bg-white text-black"}>
            <Head>
                <title>Your Personal Website</title>
                <link rel="icon" href="/favicon.ico" />
            </Head>

            <nav className={.flexContainer + " bg-white p-4 justify-end space-x-4"}>
            ...
            <main className={.flexContainer + " flex-grow p-6 flex-col items-center justify-center text-center"}>
                ...
                <div className={flexContainer + " mt-2 items-center"}>
                    <a href="https://www.linkedin.com/in/anthonshuey" target="_blank" rel="noopener noreferrer" className={logoLink}>
                        <Image src="/linkedin_logo.jpg" alt="LinkedIn Logo" width={30} height={30} className="mx-1"/>
                    </a>
                    <a href="https://www.instagram.com/shueyjanthony/" target="_blank" rel="noopener noreferrer" className={logoLink}>
                        <Image src="/instagram_logo.jpg" alt="Instagram Logo" width={48} height={48} className="mx-1"/>
                    </a>
                    <a href="https://twitter.com/AnthonyShu22260" target="_blank" rel="noopener noreferrer" className={logoLink}>
                        <Image src="/twitter_logo.jpg" alt="Twitter Logo" width={48} height={48} className="mx-1"/>
                    </a>
                </div>
            </main>

            <footer className={.flexContainer + " bg-white p-4 justify-around"}>
                <div>
