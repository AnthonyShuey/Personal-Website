...
export default function Home() {
    return (
        <div className="flex flex-col min-h-screen bg-white text-black">
            ...
            <nav className="bg-white p-4 flex justify-end space-x-4">
            ...
            <main className="flex-grow p-6 flex flex-col items-center justify-center text-center">
                ...
                <div className="flex mt-2">
                    ...
                    <a href="https://www.instagram.com/shueyjanthony/" target="_blank" rel="noopener noreferrer" className="mx-1">
                        <Image src="/instagram_logo.jpg" alt="Instagram Logo" width={48} height={48}/>
                    </a>
                    <a href="https://twitter.com/AnthonyShu22260" target="_blank" rel="noopener noreferrer" className="mx-1">
                        <Image src="/twitter_logo.jpg" alt="Twitter Logo" width={48} height={48}/>
                    </a>
                </div>
            </main>
